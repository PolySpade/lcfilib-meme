      ...
      <div className="flex flex-col md:flex-row justify-center items-center">
        ...
        <div className="p-4 flex flex-col items-left">
          ...
          <div className="flex justify-end w-full pr-4">
            ...
            <Link href="/memeseum" className="text-gray-400 text-base sm:text-xl italic font-semibold pr-5 animate-pulse">
              the memeseum
            </Link>
        ...
        {/* Right Side Grid */}
        <Link href="memeseum" className="p-4 grid grid-cols-2 gap-4 sm:gap-6 md:gap-8">
